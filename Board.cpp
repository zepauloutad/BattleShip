...
void Board::DrawEndLine(int x0, int dxcel)
{
	int i, j;
...
void Board::DrawDataLine(int line, int x0, int dxcel)
{
	int i;
...
void Board::Draw2(int x0, int y0, Board* T)
{
	int i, l, dxtab, dytab, dxcel; // , dycel;
//	dycel = 1;		
	dxcel = 3;
...
void Board::SetCell(int m_y, int m_x, char m_c)
{
...
void Board::ReadShots(ifstream& is)
{
	int size = 1, i = 0;
	Navalpoint aux;
	//cout << aux.GetC() << endl;
	...
	int Board::ReadBoatsDestroyed(ifstream & is)
	{
		int size = 1, i = 0; 
		int counter = 0;
		Navalpoint aux;
